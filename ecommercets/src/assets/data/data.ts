import { categoryObjandArray, dataObjandArray, orderObjandArray, productObjandArray } from "./generic";
...
export const category: categoryObjandArray = [
  {
    id: 1,
...
export const product: productObjandArray = [
  {
    id: 1,
